...
if __name__ == '__main__':
    ...
    from readRoadMarkFromTexture import readRoadMarkFromTexture
    from readRoadMarkFromTexture import show_road_mark
    ...
    road_mark = readRoadMarkFromTexture("../assets/terrain/baseColor5.png", n, m)
