...
void InputManager::setUp() {
  ...
  auto *keyboard0 =
      new KeyboardController(KeyboardController::PlayerIndex::Player0);
  auto *keyboard1 =
      new KeyboardController(KeyboardController::PlayerIndex::Player1);
  ...
  if (controller->connect()) {
    ...
    std::cout << "Controller connected. Player0: pad, Player1: keyboard"
              << std::endl;
  } else {
    ...
    std::cout
        << "Controller not connected. Player0: keyboard0, Player1: keyboard1"
        << std::endl;
  }
